...
public class PriceListController {
    ...
    public ResponseEntity<ApiResponse<PriceListResponse>> update(
            Authentication authentication, @PathVariable long id, @Valid @RequestBody PriceListRequest request) {
        AuthPrincipal principal = SecurityAuth.require(authentication);
        return ResponseEntity.ok(ApiResponse.success(
                HttpStatus.OK, pricingService.updatePriceList(SecurityAuth.requireCompany(principal), id, request)));
    }
